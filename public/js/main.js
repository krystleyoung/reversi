...
/* This function returns the value associated with 'whichPerson' on the URL */
...
$(function(){
	...
	$('#quit').append('<a href=lobby.html?username='+username+'" class="btn btn-danger btn-default active" role="button" aria-pressed="true">Abort</a>');
	...
	for(column = 0; column < 8; column++){
		...
		if(old_board[row][column] != board [row][column]){
			if(old_board[row][column] == '?' && board[row][column] == ' '){
				...
				$('#'+row+'_'+column).html('<img src="assets/images/emptytomoon.gif" alt="moon square"/>');
			}
			else if(old_board[row][column] == '?' && board[row][column] == 'b'){
				$('#'+row+'_'+column).html('<img src="assets/images/emptytomars.gif" alt="mars square"/>');
				...
				$('#'+row+'_'+column).html('<img src="assets/images/moontomars.gif" alt="mars square"/>');
			}
			else if(old_board[row][column] == 'b' && board[row][column] == 'w'){
				$('#'+row+'_'+column).html('<img src="assets/images/marstomoon.gif" alt="moon square"/>');
...
socket.on('game_over',function(payload){
	...
	$('#game_over').html('<h1>It\'s decided then!</h1><h2>'+payload.who_won+' won! Prepare for launch!</h2>');
	$('#game_over').append('<a href=lobby.html?username='+username+'" class="btn btn-success btn-lg active" role="button" aria-pressed="true">Return to the launch pad</a>');
